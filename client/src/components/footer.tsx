...
export default function Footer() {
  ...
  return (
    <footer className="bg-inch-dark text-white py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0C5.374 0 0 5.373 0 12s5.374 12 12 12 12-5.373 12-12S18.626 0 12 0zm5.568 8.16c-.169 1.858-.896 9.728-.896 9.728-.159 1.395-.601 1.644-1.283 1.673-1.178.045-1.975-.623-3.06-1.222l-1.88-1.218c-.669-.423-.231-1.205.384-1.727l3.359-3.206c.164-.157.307-.473-.16-.308l-4.55 2.898c-.859.548-1.357.594-2.343.416l-2.018-.632c-.859-.27-.876-.859.18-1.287l11.91-4.59c.713-.295 1.386.164 1.146 1.277Z"/>
                </svg>
              </a>
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm">
              © 2024 1inch Protocol. All rights reserved.
            </div>
